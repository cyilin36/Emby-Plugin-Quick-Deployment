...
| 区块 | 行号范围 | 说明 |
|------|---------|------|
| 全局配置 | 12-27 | 版本、路径、颜色代码等 |
| 插件定义 | 29-68 | 各插件的配置变量 |
| 工具函数 | 70-120 | 日志、输出、下载等通用函数 |
| 环境检测 | 122-150 | 检查目录、权限、依赖 |
| 备份系统 | 152-250 | 创建、列出、恢复备份 |
| 插件操作 | 252-380 | 安装、卸载核心逻辑 |
| 交互菜单 | 382-520 | 用户界面与输入处理 |
| 命令行参数 | 522-560 | 非交互式选项支持 |
